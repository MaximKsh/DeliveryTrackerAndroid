...
data class TaskModel(
        ...
        @Embedded(prefix = "instance_") var instance: Instance? = null,
        @Embedded(prefix = "author_") var author: User? = null,
        @Embedded(prefix = "performer_") var performer: User? = null,
    ...
    constructor(parcelIn: Parcel) : this(
            ...
            parcelIn.readString(),
            parcelIn.readString(),
            parcelIn.readParcelable(Instance::class.java.classLoader),
